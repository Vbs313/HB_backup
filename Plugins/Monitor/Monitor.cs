    ...
    public class Monitor : IPlugin
    {
        ...
        private Stats GetStats()
        {
            try
            {
                ...
                TimeSpan ts1 = (DateTime.Now - new DateTime(2025, 3, 26, 0, 0, 0, 0));
                TimeSpan ts2 = (new DateTime(2025, 7, 26, 0, 0, 0, 0) - DateTime.Now);
                MonitorSettings.Instance.PassportEnd = "3.26-7.26 已过" +
                    ts1.Days.ToString() + "天" +
